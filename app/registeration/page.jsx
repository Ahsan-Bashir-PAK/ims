    ...
    <div>
          <div className=' border w-screen m-auto p-3 justify-center items-center text-center h-screen bg-gradient-to-b from-blue-200   to-slate-200'>
              ...
              <form action="" method="post">
                <div className=' justify-start border border-blue-300 p-4 w-4/12 rounded-md items-start m-auto mt-40 bg-gradient-to-b from-blue-300   to-slate-100 shadow-md shadow-blue-800 '>
